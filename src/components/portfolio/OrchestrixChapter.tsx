...
export function OrchestrixChapterBlock() {
  return (
    <article className="relative pl-9 sm:pl-0">
      ...
      <div className="grid gap-12 lg:grid-cols-2 lg:grid-rows-[min-content_min-content] lg:items-start lg:gap-14">
        ...
        <div className="relative lg:col-start-1 lg:row-start-1 lg:row-span-2">
          <div className="flex flex-col gap-6">
            ...
            <motion.div
              ...
              className="hidden pl-2 sm:block"
            >
              <svg viewBox="0 0 60 50" className="mb-1 h-9 w-11 -scale-y-100 text-lavender-deep/70" fill="none" aria-hidden="true">
                <path
        ...
        >
          ...
          <div className="space-y-4 text-[14.5px] leading-[1.65] text-ink/78 sm:text-[15.5px]">
  <p>
    I'm currently working at Orchestrix Technologies, building and improving product features, internal tools, and
    AI-powered systems across the stack.
  </p>

  <p>
    I work closely with the team to turn business requirements into production-ready solutions — from frontend
    experiences and backend APIs to debugging, integrations, and feature improvements.
  </p>

  <p>
    Working with Python, Flask/FastAPI, React, TypeScript, databases, and AI technologies, I've learned to take
    ownership of problems, collaborate closely, and turn ideas into software people can actually use.
  </p>

  <p>
    Along the way, I've also gained a stronger understanding of product thinking — balancing technical decisions with
    user needs, business goals, and the practical realities of shipping and improving software.
  </p>
</div>
